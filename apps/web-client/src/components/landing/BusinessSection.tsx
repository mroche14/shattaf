      ...
      <div className="container mx-auto px-6">
        <div className="glass p-6 sm:p-10 md:p-20 rounded-[24px] sm:rounded-[40px] md:rounded-[60px] border-cyan-500/10 flex flex-col lg:flex-row items-center gap-8 md:gap-16">
          <div className="flex-1 space-y-8">
              ...
              {[
                ...
                <div key={i} className="flex gap-4">
                  ...
                  <div className="space-y-1">
                    <h5 className="text-[var(--text-main)] font-bold text-sm uppercase tracking-wider">{item.title}</h5>
                    <p className="text-[var(--text-tertiary)] text-xs leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <p className="text-[var(--text-tertiary)] text-[11px] font-black uppercase tracking-[0.18em]">Réponse sous {SITE.offer.responseTime}</p>
          </div>
