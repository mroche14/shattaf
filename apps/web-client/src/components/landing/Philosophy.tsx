      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            ...
            <div key={i} className="group p-6 sm:p-8 md:p-12 rounded-[24px] sm:rounded-[36px] md:rounded-[48px] glass border-[var(--border-color)] hover:border-cyan-500/30 transition-all hover:-translate-y-3">
              ...
              <h4 className="text-2xl font-display font-bold mb-4 text-[var(--text-main)]">{item.title}</h4>
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed font-light">{item.desc}</p>
            </div>
          ))}
        </div>
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6 pt-2">
              <div className="text-center">
                ...
                <div className="text-[var(--text-main)] font-black text-lg sm:text-2xl">~{SITE.offer.installationTimeMinutes} min</div>
                <div className="text-[11px] text-[var(--text-secondary)] uppercase tracking-[0.18em] font-black">Installation</div>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-cyan-500/10 mb-3">
                  <MapPin className="w-5 h-5 text-cyan-400" />
                </div>
                <div className="text-[var(--text-main)] font-black text-lg sm:text-2xl">"971"</div>
                <div className="text-[11px] text-[var(--text-secondary)] uppercase tracking-[0.18em] font-black">Guadeloupe</div>
              </div>
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-cyan-500/10 mb-3">
                  <ShieldPlus className="w-5 h-5 text-cyan-400" />
                </div>
                <div className="text-[var(--text-main)] font-black text-lg sm:text-2xl">{SITE.offer.responseTime}</div>
                <div className="text-[11px] text-[var(--text-secondary)] uppercase tracking-[0.18em] font-black">Réponse</div>
              </div>
            </div>
          </div>
